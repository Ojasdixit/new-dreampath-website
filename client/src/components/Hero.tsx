...
const Hero = () => {
  ...
  return (
    ...
    >
      ...
      {/* Company Logos at bottom center of video */}
      <div className="absolute bottom-20 left-1/2 transform -translate-x-1/2 w-full">
        <div className="flex items-center justify-center overflow-hidden">
          <div className="animate-scroll-loop flex items-center space-x-16">
            {/* Company Logo SVGs - White Theme */}
            <div className="flex items-center space-x-16">
              {/* Figma */}
              <svg width="48" height="48" viewBox="0 0 24 24" fill="white" className="drop-shadow-xl opacity-80 hover:opacity-100 transition-opacity">
