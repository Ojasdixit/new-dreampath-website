  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-20 left-1/2 transform -translate-x-1/2">
        <div className="relative w-[500px] h-32 bg-white/10 backdrop-blur-sm rounded-full border border-white/20 overflow-hidden">
          <div className="absolute inset-0 flex items-center justify-center" style={{ perspective: '600px' }}>
            <div className="radial-orbit relative w-full h-full" style={{ transformStyle: 'preserve-3d', transform: 'rotateX(15deg)' }}>
              {[
                { name: "Figma", angle: 0 },
                ...
                <div
                  ...
                  style={{
                    animation: `radialSpin 24s linear infinite, logoVisibility 24s linear infinite`,
                ...
                >
                  ...
                  >
                    {logo.name === "Figma" && (
                      <svg width="48" height="48" viewBox="0 0 24 24" fill="none" className="drop-shadow-2xl hover:scale-110 transition-transform">
                    ...
                    {logo.name === "Framer" && (
                      <svg width="48" height="48" viewBox="0 0 24 24" fill="#000" className="drop-shadow-2xl hover:scale-110 transition-transform">
                        <path d="M4 0h16v8h-8zm0 8h8l8 8H4zm0 8h8v8z"/>
                      </svg>
                    )}
                    {logo.name === "Dribbble" && (
                      <svg width="48" height="48" viewBox="0 0 24 24" fill="#EA4C89" className="drop-shadow-2xl hover:scale-110 transition-transform">
                        <circle cx="12" cy="12" r="12"/>
                        <path d="M8.56 2.75c4.37 6.03 6.02 9.42 8.03 17.72m2.54-15.38c-3.72 4.35-8.94 5.66-16.88 5.85m19.5 1.9c-3.5-.93-6.63-.82-8.94 0-2.58.92-5.01 2.86-7.44 6.32" stroke="white" strokeWidth="1.5" fill="none"/>
                      </svg>
                    )}
                    {logo.name === "Blender" && (
                      <svg width="48" height="48" viewBox="0 0 24 24" fill="#F5792A" className="drop-shadow-2xl hover:scale-110 transition-transform">
                    ...
                    {logo.name === "Three.js" && (
                      <svg width="48" height="48" viewBox="0 0 24 24" fill="white" className="drop-shadow-2xl hover:scale-110 transition-transform">
                        <path d="M.38 0L.48 24 12 18 23.52 24 23.62 0 12 6z"/>
                        <path d="M12 6L23.62 0 12 6 .38 0z" fill="#444"/>
                      </svg>
                    )}
                    {logo.name === "WebGL" && (
                      <svg width="48" height="48" viewBox="0 0 24 24" fill="#990000" className="drop-shadow-2xl hover:scale-110 transition-transform">
                        <path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5"/>
                        <path d="M12 2L2 7l10 5 10-5-10-5z" fill="white"/>
                      </svg>
                    )}
                    {logo.name === "Spline" && (
                      <svg width="48" height="48" viewBox="0 0 24 24" fill="#6366F1" className="drop-shadow-2xl hover:scale-110 transition-transform">
                    ...
                    {logo.name === "Cinema4D" && (
                      <svg width="48" height="48" viewBox="0 0 24 24" fill="#011A6A" className="drop-shadow-2xl hover:scale-110 transition-transform">
