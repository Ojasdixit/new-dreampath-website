        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="contact-content">
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full bg-white/10 backdrop-blur-sm border border-white/20 rounded-lg px-4 py-3 text-white placeholder-white/50 focus:outline-none focus:border-white/40 transition-colors"
              ...
              <div>
                <label className="block text-white/90 mb-2 font-medium">Subject</label>
                <input
                  type="text"
                  name="subject"
              ...
              <div>
                ...
                <textarea
                  ...
                  required
                  rows={6}
                  className="w-full bg-white/10 backdrop-blur-sm border border-white/20 rounded-lg px-4 py-3 text-white placeholder-white/50 focus:outline-none focus:border-white/40 transition-colors resize-none"
              ...
              <button
                type="submit"
                className="w-full bg-white/20 backdrop-blur-sm border border-white/30 text-white py-4 rounded-lg text-lg font-semibold hover:bg-white/30 transition-all duration-300 hover:scale-105"
              >
                Send Message
              </button>
            </form>
              ...
              <div className="space-y-6">
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <div className="text-white/80">hello@dreampath.design</div>
                  </div>
                </div>
